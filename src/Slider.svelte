...
<div class="slider">
    <img src="{images[leftIndex]}" alt="left" class="slider-item left">
    <img src="{images[centerIndex]}" alt="center" class="slider-item">
    <img src="{images[rightIndex]}" alt="right" class="slider-item right">
